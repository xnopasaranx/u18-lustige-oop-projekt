...
Fisch="geputzt"
b=int(input("Gib MAX für das auslösen des Alarms an: --> "))
...
class AlarmSystem:
    ...
    def trigger_alarm(self,a):
        x=a.get # Benötige die get-Methode für den Sensorik Wert
        if x >= b:
            print(f"\033[91mHalte Ein, Abschaum!!!So WEHRE DICH NICHT!!! Auf das Ich dir sonst verpasse, eine Fraktur!!!\033[0m")
        else:
            print(f"\033[91mDas sind nicht die Druiden, die wir suchen! Weitergehen! Weitergehen!\033[0m")
